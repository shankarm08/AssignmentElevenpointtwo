...
{
    private static final String DB_NAME = "usingsqlitee.db"; //database name
    private static final int DB_VERSION_NUMBER = 1;
    private static final String DB_TABLE_NAME = "countries";
    private static final String DB_COLUMN_1_NAME = "product_name";

    private static final String DB_CREATE_SCRIPT = "create table " + DB_TABLE_NAME +   //database table is created
    ...
    {
        ContentValues contentValues = new ContentValues();   //used to insert values to database using content values
        contentValues.put(DB_COLUMN_1_NAME, productName);
        Log.i(this.toString() + " - insertProduct", "Inserting: " + productName);
    ...
    public String[] getAllProducts()
    {
        ...
        if(cursor.getCount() >0)
        {
            ...
            while (cursor.moveToNext())  //iterarates through all the table rows
            {
